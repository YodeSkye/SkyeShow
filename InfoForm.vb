...
Partial Friend Class InfoForm
	...
	Private Sub TextPreviewKeyDown(ByVal sender As Object, ByVal e As PreviewKeyDownEventArgs) Handles tbPostMessage.PreviewKeyDown, rtbMessage.PreviewKeyDown
		...
		End Select
	End Sub
	Private Sub RTBMessageMouseDown(sender As Object, e As MouseEventArgs) Handles rtbMessage.MouseDown
		Me.rtbMessage.Focus()
	End Sub
	Private Sub TBPostMessageMouseDown(sender As Object, e As MouseEventArgs) Handles tbPostMessage.MouseDown
		Me.tbPostMessage.Focus()
	End Sub
	...
	End Sub
	Private Sub BtnEnter(ByVal sender As Object, ByVal e As EventArgs) Handles btnClearLog.Enter, btnRefreshLog.Enter
		Me.btnClose.Focus()
	End Sub
	Private Sub BtnRefreshLogClick(ByVal sender As Object, ByVal e As EventArgs) Handles btnRefreshLog.Click
		If Me.WindowState = FormWindowState.Maximized Then : My.App.ShowLog(True)
		Else : My.App.ShowLog(False)
		End If
	End Sub
